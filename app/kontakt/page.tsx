        ...
        <div className="w-full px-4 md:px-6 lg:px-8 xl:px-12 2xl:px-16">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <p className="text-lg text-muted-foreground">
              Skontaktuj się z nami lub umów wizytę. Jesteśmy tu, aby pomóc w
              każdej kwestii dotyczącej Twojego zdrowia stomatologicznego.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="w-full px-4 md:px-6 lg:px-8 xl:px-12 2xl:px-16">
          <div className="grid gap-8 lg:grid-cols-2 lg:gap-12">
              ...
              <div className="space-y-6">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-3">
                    <div>
                      <p className="font-medium">Rejestracja i informacje:</p>
                      <a
            ...
            <div className="space-y-8">
                ...
                <CardContent className="p-0">
                  <div className="aspect-[4/3] rounded-t-lg overflow-hidden">
                    <iframe
                      ...
                      title="Lokalizacja Alldent - ul. Sabinowska 8, Częstochowa"
                    ></iframe>
                  </div>
                  <div className="p-4">
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg">Jak do nas dotrzeć?</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium text-sm">Komunikacją miejską</p>
                      <p className="text-sm text-muted-foreground">
                        Przystanek &ldquo;Przykładowa&rdquo; - linie autobusowe:
                        12, 15, 23
                      </p>
                    </div>
                  </div>
        ...
        <div className="w-full px-4 md:px-6 lg:px-8 xl:px-12 2xl:px-16">
          <div className="max-w-4xl mx-auto">
            <div className="text-center space-y-4 mb-8">
              ...
              <p className="text-lg text-muted-foreground">
                Skorzystaj z wygodnego systemu rezerwacji online dostępnego 24/7
              </p>
            </div>
            ...
            <Card className="bg-white">
              <CardContent className="p-8">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    Tutaj zostanie umieszczony widget ZnanyLekarz umożliwiający
                    rezerwację wizyt online. Widget będzie zintegrowany z
                    systemem zarządzania terminami gabinetu.
                  </p>
        ...
        <div className="w-full px-4 md:px-6 lg:px-8 xl:px-12 2xl:px-16">
          <div className="max-w-2xl mx-auto text-center space-y-8">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <Button size="lg" variant="outline" asChild>
                <a href="mailto:kontakt@Alldent-czestochowa.pl">
            ...
            <div className="pt-4 text-sm text-muted-foreground space-y-2">
              <p>
                <strong>Czas odpowiedzi na email:</strong> do 24 godzin w dni
                robocze
              </p>
              <p>
