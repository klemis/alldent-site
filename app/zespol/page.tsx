        ...
        <div className="w-full px-4 md:px-6 lg:px-8 xl:px-12 2xl:px-16">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <p className="text-lg text-muted-foreground">
              Poznaj doświadczonych specjalistów, którzy z pasją dbają o zdrowie
              Twoich zębów i piękny uśmiech całej rodziny.
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-6 pt-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium">Ciągłe doskonalenie</span>
              </div>
            </div>
          </div>
        </div>
                  ...
                  <div className="md:col-span-2 space-y-4">
                    ...
                    <CardContent className="p-0 space-y-6">
                      ...
                      <div className="space-y-2">
                        <h3 className="font-semibold text-sm">Specjalizacje</h3>
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <div className="space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  Rozumiemy lęki pacjentów i zawsze podchodzimy z cierpliwością
                  i zrozumieniem
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  Regularnie uczestniczymy w kursach i szkoleniach, aby być na
        ...
        <div className="w-full px-4 md:px-6 lg:px-8 xl:px-12 2xl:px-16">
          <div className="max-w-2xl mx-auto text-center space-y-6">
            ...
            <p className="text-lg opacity-90">
              Umów się na konsultację i przekonaj się, jak profesjonalna opieka
              może wyglądać w przyjaznej atmosferze.
            </p>
