            ...
            <div className="max-w-7xl mx-auto">
              <div className="max-w-3xl mx-auto text-center space-y-4">
                ...
                <p className="text-lg text-muted-foreground">
                  Zobacz nasze nowoczesne wnętrza, profesjonalny sprzęt medyczny
                  i poznaj zespół specjalistów Alldent w Częstochowie.
                </p>
                  ...
                  <Card>
                    <CardContent className="p-6 text-center space-y-3">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Przestronne i komfortowe gabinety zaprojektowane z myślą
                        o komforcie pacjentów
                      </p>
                    </CardContent>
                  </Card>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="max-w-2xl mx-auto text-center space-y-6">
                ...
                <p className="text-lg opacity-90">
                  Umów wizytę i zobacz na własne oczy nasze nowoczesne wnętrza
                  oraz poznaj nasz profesjonalny zespół.
                </p>
