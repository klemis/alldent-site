            ...
            <Card className="border-primary">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-start gap-3 text-green-700 bg-green-50 p-3 rounded-lg">
                  ...
                  <div>
                    <p className="font-medium">Zalecany sposób rezerwacji</p>
                    <p className="text-sm">
                      Dostępny 24/7, natychmiastowe potwierdzenie, widok wolnych
                      terminów
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-slate-100 p-8 rounded-lg border-2 border-dashed border-slate-300">
                  <div className="text-center space-y-4">
                    ...
                    <p className="text-sm text-slate-600">
                      Tutaj zostanie umieszczony interaktywny widget ZnanyLekarz
                      umożliwiający wybór daty, godziny i rodzaju wizyty.
                    </p>
                    <div className="pt-2">
                      <Button asChild>
                        <a
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  Preferujesz osobisty kontakt? Zadzwoń do nas w godzinach pracy
                  i umów wizytę bezpośrednio z naszą recepcjonistką.
                </p>
        ...
        <div className="w-full px-4 md:px-6 lg:px-8 xl:px-12 2xl:px-16">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg">Odwołanie wizyty</CardTitle>
                </CardHeader>
                <CardContent className="space-y-2 text-sm">
